...
{
    [CreateAssetMenu(menuName = "Game/Skills/GenericImagesRepository", fileName = "New SkillImageRepository", order = 0)]
    public class SkillImageRepository : ScriptableObject, IRepository<Sprite, string>
    {
